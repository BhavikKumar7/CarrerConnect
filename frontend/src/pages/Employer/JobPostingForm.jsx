          ...
          <div className="bg-white shadow-xl rounded-2xl p-6">
            ...
            <div className="space-y-6">
              ...
              <TextareaField
                ...
                helperText="Include key responsibilites, day-to-day tasks, and what make this role exciting"
                required
              />
                ...
                <div className="grid grid-cols-3 gap-3">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-10 pr-3 py-2.5 border border-gray-300 rounded-lg text-base focus:outline-none focus:ring-offset-blue-500 focus:ring-opacity-20 focus:border-blue-500 transition-colors duration-200`}
                    />
                  </div>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none z-10">
              ...
              <div className="pt-2">
                <button
                  ...
                  className="w-full flex items-center justify-center px-4 py-3 border border-transparent text-base font-medium rounded-lg text-white bg-gradient-to-r from-primary to-secondary focus:outline-none focus-ring-offset-2 focus:ring-primary disabled:bg-gray-400 disabled:cursor-not-allowed outline-none transition-colors duration-200"
                >
                  {isSubmitting ? (
                    <>
