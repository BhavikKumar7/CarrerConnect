...
const ApplicationViewer = () => {
  ...
  const fetchApplications = async () => {
    try {
      setLoading(true);
      const response = await axiosInstance.get(API_PATHS.APPLICATIONS.GET_ALL_APPLICATION(jobId));
                          ...
                          >
                            ...
                            <div className="flex items-center gap-3 mt-4 md:m-0">
                              ...
                              <button
                                ...
                                className="inline-flex items-center gap-2 px-3 py-2 bg-gray-700 text-sm font-medium rounded-lg hover:bg-gray-200 transition-colors"
                              >
