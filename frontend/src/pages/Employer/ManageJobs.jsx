        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            <div className="flex flex-row items-center justify-between">
              ...
              <button
                className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-primary to-secondary text-sm text-white font-semibold rounded-xl shadow-lg shadow-primary hover:shadow-xl hover:shadow-secondary transition-all duration-300 transform hover:-translate-y-0.5 whitespace-nowrap"
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <div className="sm:w-48">
                <select
                  ...
                  className="block w-full pl-10 pr-4 py-2 text-sm border border-gray-200 rounded-lg focus:ring-blue-500/20 focus:border-blue-500 outline-0 transition-all duration-200"
                >
                  ...
                  <table className="min-w-full divide-y divide-gray-200">
                    <thead className="bg-gradient-to-r from-gray-50 to-gray-100/50">
                      <tr>
                        ...
                        <th className="px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider min-w-[200px] sm:min-w-0">
                          Actions
                        </th>
                      </tr>
                    </thead>
                    <tbody className="bg-white divide-y divide-gray-200">
                      {isLoading
                        ...
                        : paginatedJobs.map((job) => (
                          <tr
                            key={job.id}
                            className="hover:bg-primary/10 transition-all duration-200 border-b border-gray-100/60"
                          >
                            ...
                            <td className="px-6 py-5 whitespace-nowrap min-w-[120px] sm:min-w-0">
                              <button
                                className="flex items-center text-sm text-primary font-semibold transition-colors duration-200 hover:bg-primary/30 px-2 py-1 rounded-lg"
                                onClick={() =>
                                  navigate("/applicants", {
                                    state: { jobId: job.id },
                                  })
                            ...
                            <td className="px-6 py-4 whitespace-nowrap text-sm font-medium min-w-[180px] sm:min-w-0">
                              <div className="flex space-x-2">
                                <button
                                  className="text-primary hover:text-primary/50 p-2 rounded-lg hover: bg-primary/30 transition-colors duration-200"
                                  onClick={() =>
                                    navigate("/post-job", {
                                      state: { jobId: job.id },
                                    })
                        ...
                        (page) => (
                          <button
                            ...
                            className={`relative inline-flex items-center px-4 py-2 border text-sm font-medium ${currentPage === page
                                ? "z-10 bg-primary/30 border-primary text-primary"
